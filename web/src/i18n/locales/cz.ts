  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        media: 'Virtuální obraz',
        mediaDesc: 'Připojit vybraný soubor obrazu ke vzdálenému hostiteli',
        disk: 'Virtuální disk',
        diskDesc: 'Zpřístupnit datové úložiště NanoKVM vzdálenému hostiteli',
